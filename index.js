...
function TweetSheet() {
  ...
  return (
    ...
    <>
    <h1 id="id1">Disappearing Tweet</h1>
...
function disabledDate(current) {
  // Can not select days before today and today
  //console.log('Test TIme',current && current < moment().endOf('day'));
  return current && current < moment().endOf('day');
...
// var startDate = ('#Date').data('Rangepicker').startDate._d;
// var endDate = ('#Date').data('Rangepicker').endDate._d;
// alert(startDate);
...
ReactDOM.render(
  ...
  /> */}
  <TodoList/>
  <App1 /></Provider>,document.getElementById("root"));
  // // ReactDOM.render(
  //   <Provider store={store}><App1 /></Provider>, document.getElementById("root"));
